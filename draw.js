(function() {
  var authorHeight, authors, barHeight, barWidth, canvas, canvasHeight, canvasWidth, context, drawLinks, drawRectangle, drawSignet, drawText, height, leftOffsetHack, lineHeightHack, links, repeatHack;
  ...
  drawSignet = function() {
    var author, barTop, colors, hue, i, imageCSS, individualBarLeft, individualBarWidth, j, letter, _i, _j, _len, _len1;
